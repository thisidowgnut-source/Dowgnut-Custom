        ...
        {items.map((item) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "relative flex flex-1 flex-col items-center justify-center gap-1 py-2 cursor-pointer transition-colors select-none rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-dowgnut-blue)]",
                isActive
                  ? "text-[var(--color-dowgnut-blue)]"
                  : "text-[var(--color-dowgnut-blue-dark)]/80 hover:text-[var(--color-dowgnut-blue-dark)]"
              )}
